...
function testBMI() {
    if (markDetails.bmi > johnDetails.bmi) {
        console.log(`Mark's BMI (${markDetails.bmi}) is higher than John's BMI (${johnDetails['bmi']})`);
    } else {
    if (johnDetails.bmi > markDetails.bmi) {
        console.log(`John's BMI (${markDetails.bmi}) is higher than Mark's BMI`); 
    } 
}
};

console.log(testBMI(markDetails.bmi,johnDetails.bmi));
*/